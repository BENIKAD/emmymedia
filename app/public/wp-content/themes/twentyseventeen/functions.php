...
function twentyseventeen_setup() {
	...
	$starter_content = array(
		...
		'attachments' => array(
			'image-camera-bg' => array(
				'post_title' => _x( 'camera-bg', 'Theme starter content', 'twentyseventeen' ),
				'file'       => 'assets/images/camera-bg.jpg', // URL relative to the template directory.
			),
			'image-camera-bg' => array(
				'post_title' => _x( 'camera-bg', 'Theme starter content', 'twentyseventeen' ),
				'file'       => 'assets/images/camera-bg.jpg',
			),
			'image-coffee'   => array(
